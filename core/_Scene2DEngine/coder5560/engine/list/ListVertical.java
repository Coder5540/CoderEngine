...
public class ListVertical extends GroupElement {

	Table						root;
	Pool<AbstractItem>			pool;
	...
	public ListVertical(float width, float height) {
		super();
		{
		...
		for (int i = 0; i < 500000; i++) {
			datas.add(new DataItemList(i, "Element " + i, "Description : " + i,
					width, 60 + i % 20, onSelectListener));
		}
	...
	public void buildListener() {
		...
		root.addListener(new ActorGestureListener() {
			...
			public void fling(InputEvent event, float velocityX,
				...
				ListVertical.this.velocityY = velocityY;
